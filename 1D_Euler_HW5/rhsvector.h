...
void rightfaceflux(vector< vector<vector<double> > > Uelem, int degree, vector<vector <double> > &faceflux, int nelem, int neqns, double g, int fluxscheme, double t)
{
...
void rhsvector(vector< vector<vector<double> > > &R, int nelem, vector< vector<vector<double> > > Uelem, int degree, int fluxscheme, double deltax, int neqns, double g, double deltat)
{
    ...
    rightfaceflux(Uelem, degree, faceflux, nelem, neqns,g, fluxscheme,deltat);   
    /**************************************************/
