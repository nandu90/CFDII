...
void control(double &x0, double &xn, int &ncells, vector<double> &u, int &degree, double &cfl, double &a, int &fluxscheme, double &totaltime, int &stages, vector<double> &ucenter)
{
